...
--// SNIPPET 2 - DASH LOGIC + ANIMATION BLOCKING
...
-- CHECK IF ANY ANIMATION IS PLAYING (blocks dash if anim playing)
...
--// SNIPPET 4 - APPLY FUNCTIONS + BUTTON LOGIC + DOUBLE-CLICK TARGET
